$(document).ready(function(){
	...
	//evento que se dispara al hacer clic en el boton para agregar una nueva fila en la unidad academica
	$(document).on('click','.clsAgregarFila',function(){
		...
		var strNueva_Fila='<tr>'+
			...
			'<td><input type="text" style="height: 25px; text-transform:uppercase; border-radius:5px" class="clsAnchoTotal" ></td>'+
