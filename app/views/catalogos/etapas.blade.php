...
<html lang="es">
	...
	<body>
		...
		<form  action="<?=URL::to('catalogos/registraretapas'); ?>" class="md-content" method="post">
			...
			<div class="tblCatalogos">
				<table class="tblCatPlan">
					...
					<tr>
						<td>Nombre:</td>
						<td><input style="width: 200px; height: 30px; border-radius: 5px; border-color: #DBDBEA;"  type="text" name="etapas_descripcion" id="txtCatDescripcionEtapas" size=1 /></td>
					</tr>
				</table>
			</div>
		...
		<section>
			<div><div style="display:inline-block; float:left;">Etapas</div>
