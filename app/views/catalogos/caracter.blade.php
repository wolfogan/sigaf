		...
		<form  action="<?=URL::to('catalogos/registrarcaracter'); ?>" class="md-content" method="post">
			...
			<div class="tblCatalogos">
				<table class="tblCatPlan">
					...
					<tr>
						<td>Nombre:</td>
						<td><input style="width: 200px; height: 30px; border-radius: 5px; border-color: #DBDBEA;"  type="text" name="caracteres_descripcion" id="txtCatDescripcionCaracteres" size=1 /></td>
					</tr>
				</table>
			</div>
