		...
		<section>
			...
			<div id="formularioRegUsuarios">
						...
						<div class="us_txtNoEmpleado">No. Empleado:
							<input style="margin-left:48px" class="dd_estilo_combo" type="text"  name="nombreRegUsuarios" id="nombreRegUsuarios" size=1>
						</div>
				
						<div class="us_txtNoEmpleado">A. Paterno:		
							<input style="margin-left:70px" class="dd_con_estilo_largo" type="text" name="apellidosRegUsuarios" id="apellidosRegUsuarios" size=1>
						</div>

						<div class="us_txtNoEmpleado">A. Materno:		
							<input style="margin-left:68px" class="dd_con_estilo_largo" name="apellidosRegUsuarios" id="apellidosRegUsuarios" size=1>
						</div>

						<div class="us_txtNoEmpleado">Nombre:
							<input style="margin-left:91px" class="dd_con_estilo_largo" type="text" name="nombreRegUsuarios" id="nombreRegUsuarios" size=1>
						</div>

						
					
						<div class="us_txtNoEmpleado">Correo:
							<input style="margin-left:98px" class="dd_con_estilo_largo" type="text" name="correoE" id="correoE" size=1>
						</div>

						<div class="us_txtNoEmpleado">Repetir correo:
							<input style="margin-left:43px" class="dd_con_estilo_largo" type="text" name="correoE" id="correoE" size=1>
						</div>

						<div class="us_txtNoEmpleado">Contraseña:
							<input style="margin-left:67px" class="dd_con_estilo_largo" type="password" placeholder="RFC" name="contrasenaRegUsuarios" id="contrasenaRegUsuarios" size=1>
						</div>

						<div class="us_txtNoEmpleado">Repetir Contraseña:
							<input style="margin-left:10px" class="dd_con_estilo_largo" type="password" placeholder="RFC" name="contrasenaRegUsuarios" id="contrasenaRegUsuarios" size=1>
						</div>


						<div class="us_txtNoEmpleado">Nivel:
							<select style="margin-left:110px" class="dd_con_estilo_largo">
						...
						<div class="us_txtNoEmpleado">Puesto:	
							<select style="margin-left:100px" class="dd_con_estilo_largo">
								<option>DIRECTOR</option>
								<option>SUBDIRECTOR</option>
								<option>COORDINADOR</option>
							</select>
							<!-- TABLA MODAL PUESTO-->
							<div class="btnUnidadAcadRegistro"><input style="width:30px; height:30px;" class="md-trigger" data-modal="us_puesto" type="button" value="+"></a></div>
							<!--             -->
						</div>

				
						<div class="us_txtNoEmpleado">Categoría:
						...
						<div class="us_txtNoEmpleado">Unidad Académica:
								<select style="margin-left:18px" class="dd_con_estilo_largo" type="text" placeholder="Unidad académica" name="campusRegUsuarios" id="campusRegUsuarios"> 
									<option value="FCA">FCA</option>
									<option value="FCQ">FCQ</option>
									<option value="FNI">FNI</option>
								</select>
							    <!-- TABLA MODAL UNIDAD ACADEMICA-->
								<div class="btnUnidadAcadRegistro"><input style="width:30px; height:30px;" class="md-trigger" data-modal="us_uacad" type="button" value="+"></a></div>
								<!--     -->
						</div>
							

						<div class="us_txtNoEmpleado">Campus:
								<select style="margin-left:90px" class="dd_con_estilo_largo" type="text" placeholder="Campus" name="campusRegUsuarios" id="campusRegUsuarios">
